# Ohhopi's Dalamud Plugin Repository
...
3. Copy and Paste in the following URL into one of the blank inputs under the "Custom Plugin Repositories" section: `https://github.com/ohhopi/DalamudPluginRepo/raw/master/pluginmaster.json`
